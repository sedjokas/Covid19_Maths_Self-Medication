...
def scenario4_bifurcation_coefficient(outdir_fig='figures', outdir_data='data'):
    """
...
def scenario5_no_bistability(outdir_fig='figures', outdir_data='data'):
    """
    Scenario 5: at phi_1=0.05, alpha=0.0992 (R0 approx 0.988 < 1), integrate
    ...
    p['alpha'] = 0.0992
    R0 = calculate_R0(p)
    print(f"Scenario 5: R0 = {R0:.4f} at phi_1=0.05, alpha=0.0992")
